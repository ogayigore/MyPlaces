...
class MapViewController: UIViewController {
    ...
    private func getDirections() {
        ...
        guard let request = createDireectionRequest(from: location) else {
    ...
    private func createDireectionRequest(from coordinate: CLLocationCoordinate2D) -> MKDirections.Request? {
